...
void PlayerRender() {
	...
	CUSTOMVERTEX Player[] = {
		...
		{ PLAYERSIZEWIDHE,0.0f,0.5f,1.0f,0xFFFFFFFF,1.0f,0.0f },
		{ PLAYERSIZEWIDHE,PLAYERSIZEHEIGHT,0.5f,1.0f,0xFFFFFFFF,1.0f,1.0f },
		{ 0.0f,PLAYERSIZEHEIGHT,0.5f,1.0f,0xFFFFFFFF,0.0f,1.0f }
	};
